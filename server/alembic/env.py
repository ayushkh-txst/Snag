...
# attempted — this is ConfigParser's own quoting rule, not something
# `sqlalchemy_url` should know about. Mirrors CiteDelta-RAG/alembic/env.py.
...
# no ORM models; every migration is raw SQL
